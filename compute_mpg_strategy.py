...
DEFAULT_TOP_BETS_XLSX_OUT = "data/mpg/mpg_semifinal_top5_bets.xlsx"
...
def write_top_bets_xlsx(
    ...
    files = {
        ...
        "xl/workbook.xml": (
            ...
            'xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">'
            '<sheets><sheet name="Semifinal Top 5" sheetId="1" r:id="rId1"/></sheets>'
            '</workbook>'
        ),
        ...
        "docProps/core.xml": (
            ...
            '<dc:title>MPG Semifinal Top 5 Bets</dc:title>'
