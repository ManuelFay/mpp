...
DEFAULT_TOP_BETS_XLSX_OUT = "data/mpg/mpg_quarterfinal_top5_bets.xlsx"
...
DEFAULT_STRATEGY_EVENT_LIMIT = 4
DEFAULT_COMPARE_EVENT_OFFSET = 0
DEFAULT_COMPARE_EVENT_LIMIT = 4
...
def write_top_bets_xlsx(
    ...
    files = {
        ...
        "xl/workbook.xml": (
            ...
            'xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">'
            '<sheets><sheet name="Quarterfinal Top 5" sheetId="1" r:id="rId1"/></sheets>'
            '</workbook>'
        ),
        ...
        "docProps/core.xml": (
            ...
            '<dc:title>MPG Quarterfinal Top 5 Bets</dc:title>'
