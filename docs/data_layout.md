...
data/odds_snapshots/
  ...
  YYYY/
    MM/
      world_cup_round_of_16_odds_YYYYMMDDTHHMMSSZ.csv
```
...
python3 compute_mpg_strategy.py \
  --odds-file data/odds_snapshots/2026/07/world_cup_round_of_16_odds_20260704T213826Z.csv \
...
`simulate_bookmaker_injected.py` writes transfer-aware strategy distributions
and per-game audit tables here:
